...
export default {
  ...
  data() {
    return {
      ...
      makeOutRange: [],
      columnList: [
        { name: '发票代码', disable: true, prop: 'code', minWidth: '150' },
        { name: '发票号码', disable: true, prop: 'no', minWidth: '150' },
        { name: '开票日期', disable: true, prop: 'makeOutDate', minWidth: 100 },
        { name: '发票状态', disable: true, prop: 'status', minWidth: 80 },
        { name: '发票校验码', disable: true, prop: 'validCode', minWidth: 100 },
        { name: '发票类型', disable: true, prop: 'type', minWidth: 100 },
        { name: '价税合计', disable: false, prop: 'totalAmount', width: 80 },
        { name: '不含税金额', disable: false, prop: 'notTaxAmount', width: 80 },
        { name: '税额', disable: false, prop: 'taxAmount', width: 80 },
        { name: '发票备注', disable: false, prop: 'remark' },
        { name: '开票人', disable: false, prop: 'drawer', width: 80 },
        { name: '收款人', disable: false, prop: '', width: 80 },
        { name: '复核人', disable: false, prop: 'auditor', width: 80 },
        { name: '购买客户编号', disable: false, prop: 'code', width: '150' },
        { name: '购买方名称', disable: false, width: '120' },
        { name: '购买方纳税人识别号', disable: false, prop: 'customerID', width: '150' },
        { name: '购买方开户行及账号', disable: false, prop: 'customerBankAddressAndNo', width: '150' },
        { name: '购买方地址及电话', disable: false, prop: 'customerAddressAndPhone', width: '120' },
        { name: '销售订单号', disable: false, prop: 'saleOrderNo', width: '150' },
        { name: '销方纳税人识别号', disable: false, width: '150' },
        { name: '销方银行及账号', disable: false, width: 150 },
        { name: '销方地址及电话', disable: false, width: 100 },
        { name: '电子发票pdfurl', disable: false, width: 150 },
        { name: '开票税率', disable: false, width: 80 },
        { name: '单据ID', disable: false, width: 150 },
        { name: '单据编号', disable: false, prop: 'billId', width: 150 },
        { name: '单据日期', disable: false, prop: 'billDate', width: 100 },
        { name: '客户订单号', disable: false, prop: 'customerOrderNo', width: 150 },
        { name: '公司编号', disable: false, prop: 'companyNo', width: 100 },
        { name: '门店编号', disable: false, prop: 'shopNo', width: 100 },
        { name: '单据类型', disable: false, width: 80 },
        { name: '采购订单号', disable: false, width: 150 },
        { name: '往来单位编号', disable: false, width: 100 },
        { name: '经办人信息', disable: false, prop: 'agentInfo', width: 100 },
        { name: '经办人信息2', disable: false, prop: 'agentInfo2', width: 100 }
