<template>
  <div>
    <div class="menu-detailSty">
      <div class="detail-title">新增发票</div>
...
export default {
  ...
  data() {
    return {
      ...
      {
        dateName: 'customerAddressAndPhone',
        meaning: '客户地址和电话',
        rule: '',
        confirm: '非必须',
        defaultValue: ''
